...
URLS = flatten(
    (
        ...
        url_test(
            "/firefox/browsers/mobile/app/?product=focus&campaign=firefox-browsers-mobile-focus",
            "https://apps.apple.com/app/apple-store/id1055677337?mz_pr=firefox_mobile&pt=373246&ct=firefox-browsers-mobile-focus&mt=8",
            req_headers=UA_IOS,
            resp_headers={"Cache-Control": "max-age=0"},
        ),
        url_test(
        ...
        url_test(
            "/firefox/browsers/mobile/app/?product=klar&campaign=firefox-browsers-mobile-focus",
            "https://apps.apple.com/app/apple-store/id1073435754?mz_pr=firefox_mobile&pt=373246&ct=firefox-browsers-mobile-focus&mt=8",
            req_headers=UA_IOS,
            resp_headers={"Cache-Control": "max-age=0"},
        ),
        # Issue 14221
        ...
        url_test(
            "/products/vpn/mobile/app/?product=vpn&campaign=vpn-landing-page",
            "https://apps.apple.com/app/apple-store/id1489407738?mz_pr=firefox_mobile&pt=373246&ct=vpn-landing-page&mt=8",
            req_headers=UA_IOS,
            resp_headers={"Cache-Control": "max-age=0"},
        ),
        # Issue 15386
