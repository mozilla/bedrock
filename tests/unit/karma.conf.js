module.exports = function(config) {
    config.set({
        ...
        files: [
            ...
            'media/js/firefox/hello/hello-ftu-minimal.js',
            'media/js/firefox/win10-welcome.js',
            ...
            'tests/unit/spec/firefox/hello/hello-ftu-minimal.js',
            'tests/unit/spec/firefox/win10-welcome.js',
