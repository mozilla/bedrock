...
describe('mozilla-client.js', function () {
    ...
    describe('getFxaConnections', function () {
        ...
        it('should fire the callback function with a FxaConnections details object', function () {
            ...
            expect(callback1).toHaveBeenCalled();
            expect(typeof window.Mozilla.Client.FxaConnections.firefox).toEqual(
                'boolean'
            );
            expect(
                typeof window.Mozilla.Client.FxaConnections.unsupported
            ).toEqual('boolean');
            expect(typeof window.Mozilla.Client.FxaConnections.setup).toEqual(
                'boolean'
            );
            expect(
                typeof window.Mozilla.Client.FxaConnections.numOtherDevices
            ).toEqual('boolean');
            expect(
                typeof window.Mozilla.Client.FxaConnections.numDevicesByType
            ).toEqual('object');
            expect(
                typeof window.Mozilla.Client.FxaConnections.accountServices
            ).toEqual('object');
        });
        ...
        it('should identify legacy Firefox browsers as expected', function () {
            ...
            expect(
                window.Mozilla.Client.FxaConnections.unsupported
            ).toBeTruthy();
        });
    ...
    describe('isFirefoxOutOfDate', function () {
        it('should return true if client version is equal to or less than the major version considered out of date', function () {
            const result = Mozilla.Client.isFirefoxOutOfDate(
                '50.0',
                2,
                '56.0.1'
            );
            ...
            const result2 = Mozilla.Client.isFirefoxOutOfDate(
                '54.0',
                2,
                '56.0'
            );
            ...
            const result3 = Mozilla.Client.isFirefoxOutOfDate(
                '54.0a1',
                2,
                '56.0.1a1'
            );
            ...
            const result4 = Mozilla.Client.isFirefoxOutOfDate(
                '55.0.1',
                1,
                '56.0'
            );
    ...
    describe('isFirefoxURLOutOfDate', function () {
        it('should return true if URL version is equal to or less than the major version considered out of date', function () {
            const result = Mozilla.Client.isFirefoxURLOutOfDate(
                2,
                '/firefox/54.0/',
                '56.0'
            );
            ...
            const result2 = Mozilla.Client.isFirefoxURLOutOfDate(
                2,
                '/firefox/54.0a1/',
                '56.0'
            );
            ...
            const result3 = Mozilla.Client.isFirefoxURLOutOfDate(
                2,
                '/firefox/54.0a2/',
                '56.0'
            );
            ...
            const result4 = Mozilla.Client.isFirefoxURLOutOfDate(
                1,
                '/firefox/55.0.1/',
                '56.0'
            );
            ...
            const result5 = Mozilla.Client.isFirefoxURLOutOfDate(
                2,
                '/firefox/53.0/',
                '56.0'
            );
