...
describe('mozilla-traffic-cop-funnelcake-geo.js', function () {
    ...
    describe('preCheckGeo', function () {
        it('should return false if less than IE 9', function () {
            expect(
                Mozilla.TCFCGeoExp.preCheckGeo(
        ...
        it('should return false if a funnelcake id is in the URL', function () {
            expect(
                Mozilla.TCFCGeoExp.preCheckGeo(null, null, '?f=111')
            ).toBeFalsy();
            expect(
                Mozilla.TCFCGeoExp.preCheckGeo(null, null, '?foo=bar&f=111')
            ).toBeFalsy();
            expect(
                Mozilla.TCFCGeoExp.preCheckGeo(null, null, '?f=111&bar=baz')
            ).toBeFalsy();
        });
    ...
    describe('geoLookup', function () {
        ...
        it('should call runExperiment if country matches', function () {
            ...
            expect(Mozilla.TCFCGeoExp.runExperiment).toHaveBeenCalledWith(
                someConfig
            );
        });
    });
