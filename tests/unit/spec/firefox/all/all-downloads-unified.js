            ...
            <ol class="c-locale-list" data-product="android_release">
                <li class="c-locale-list-item" data-language="multi">
                    ...
                    <ul class="c-download-list">
                        ...
                        <li><a href="/en-US/firefox/browsers/mobile/get-app/" class="c-get-app" data-cta-text="Get It Now" data-cta-position="banner">Send a download link to your phone</a></li>
                    </ul>
                </li>
            </ol>`;
