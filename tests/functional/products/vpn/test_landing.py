...
def test_vpn_available_in_country(base_url, selenium):
    ...
    assert page.is_try_vpn_hero_fixed_price_button_displayed
    assert not page.is_join_waitlist_hero_button_displayed
    assert page.is_try_vpn_navigation_fixed_price_button_displayed
    assert not page.is_join_waitlist_navigation_button_displayed
    assert page.is_try_vpn_conntect_now_fixed_price_button_displayed
    assert not page.is_join_waitlist_coming_soon_button_displayed
    assert page.is_try_vpn_fixed_pricing_section_button_displayed
    assert not page.is_join_waitlist_fixed_pricing_section_button_displayed
    assert page.is_try_vpn_footer_fixed_price_button_displayed
...
def test_vpn_not_available_in_country(base_url, selenium):
    ...
    assert not page.is_try_vpn_hero_fixed_price_button_displayed
    assert page.is_join_waitlist_hero_button_displayed
    assert not page.is_try_vpn_navigation_fixed_price_button_displayed
    assert page.is_join_waitlist_navigation_button_displayed
    assert not page.is_try_vpn_conntect_now_fixed_price_button_displayed
    assert page.is_join_waitlist_coming_soon_button_displayed
    assert not page.is_try_vpn_fixed_pricing_section_button_displayed
    assert page.is_join_waitlist_fixed_pricing_section_button_displayed
    assert not page.is_try_vpn_footer_fixed_price_button_displayed
