...
from pages.firefox.whatsnew.whatsnew_69 import FirefoxWhatsNew69Page


@pytest.mark.skip_if_not_firefox(reason='Whatsnew pages are shown to Firefox only.')
@pytest.mark.nondestructive
def test_signed_out_monitor_button_displayed(base_url, selenium):
    page = FirefoxWhatsNew69Page(selenium, base_url, params='').open()
...
def test_signed_in_monitor_button_displayed(base_url, selenium):
    page = FirefoxWhatsNew69Page(selenium, base_url, params='?signed-in=true').open()
