...
from pages.firefox.whatsnew.whatsnew_68 import FirefoxWhatsNew68Page


@pytest.mark.skip_if_not_firefox(reason='Whatsnew pages are shown to Firefox only.')
@pytest.mark.nondestructive
def test_signed_out_firefox_accounts_form_displayed(base_url, selenium):
    page = FirefoxWhatsNew68Page(selenium, base_url, params='').open()
...
def test_signed_in_monitor_button_displayed(base_url, selenium):
    page = FirefoxWhatsNew68Page(selenium, base_url, params='?signed-in=true').open()
