...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Release.bug_list'
        db.add_column('rna_release', 'bug_list',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Release.bug_search_url'
        db.add_column('rna_release', 'bug_search_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Release.bug_list'
        db.delete_column('rna_release', 'bug_list')

        # Deleting field 'Release.bug_search_url'
        db.delete_column('rna_release', 'bug_search_url')
