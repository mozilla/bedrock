...
DONATE_PARAMS = {
    ...
    "gbp": {"currency": "gbp", "symbol": "£", "presets": "60,30,20,10", "default": "30", "prefix": "true"},
    "hkd": {"currency": "hkd", "symbol": "HK$", "presets": "100,50,25,18", "default": "50", "prefix": "true"},
    "huf": {"currency": "huf", "symbol": "Ft", "presets": "5600,2800,1400,850", "default": "2800", "prefix": "false"},
    "inr": {"currency": "inr", "symbol": "₹", "presets": "1000,500,350,200", "default": "500", "prefix": "true"},
    "jpy": {"currency": "jpy", "symbol": "¥", "presets": "2240,1120,560,340", "default": "1120", "prefix": "true"},
    "mxn": {"currency": "mxn", "symbol": "MX$", "presets": "400,200,100,60", "default": "200", "prefix": "true"},
    "nok": {"currency": "nok", "symbol": "kr", "presets": "160,80,40,20", "default": "80", "prefix": "false"},
    "nzd": {"currency": "nzd", "symbol": "NZ$", "presets": "60,30,20,10", "default": "30", "prefix": "true"},
...
GOOGLE_ANALYTICS_GTM_ID = config("GOOGLE_ANALYTICS_GTM_ID", default="")  # Not used in all Bedrock modes (Pocket only).
