...
# Cyber security month offer (Issue 10539)
VPN_LIMITED_OFFER_MONTHLY_PRICE_USD = "US$4.99"
VPN_LIMITED_OFFER_MONTHLY_PLAN_USD = "plan_FvPMH5lVx1vhV0" if DEV else "plan_FvnxS1j9oFUZ7Y"
