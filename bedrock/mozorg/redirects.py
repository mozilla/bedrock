...
redirectpatterns = (
    ...
    # Issue 8375 /internet-health/ -> mozillafoundation.org
    redirect(r"^privacy/you/?$", "https://mozillafoundation.org/internet-health/"),
    redirect(r"^privacy/tips/?$", "https://mozillafoundation.org/internet-health/"),
    ...
    redirect(r"^access/donate(\.html|/)?$", "https://mozillafoundation.org/donate/"),
    # bug 1148187
    ...
    redirect(r"^foundation/openwebfund/(index\.html)?$", "https://mozillafoundation.org/donate/", re_flags="i"),
    redirect(r"^foundation/donate\.html$", "https://mozillafoundation.org/donate/", re_flags="i"),
    ...
    # Bug 1313023
    redirect(r"^story/?$", "https://mozillafoundation.org/donate/"),
    # Bug 1317260
    redirect(
    ...
    redirect(r"^onlineprivacy/?$", "https://mozillafoundation.org/internet-health/"),
    # Bug 1335569 - vanity URL, Issue 8375
    redirect(r"^digital-inclusion/?$", "https://mozillafoundation.org/internet-health/"),
    # Bug 1344270 - vanity URL, Issue 8375
    redirect(r"^open-innovation/?$", "https://mozillafoundation.org/internet-health/"),
    # Bug 1333146
    ...
    redirect(r"^internethealth/?$", "https://mozillafoundation.org/internet-health/"),
    ...
    redirect(r"^teach/?$", "https://mozillafoundation.org/internet-health/"),
    redirect(r"^teach/smarton/?$", "https://mozillafoundation.org/internet-health/"),
    redirect(r"^teach/smarton/(?:tracking|security|surveillance)/?$", "https://mozillafoundation.org/internet-health/"),
    # issue 6266
    redirect(r"^about/policy/leandata/?$", "mozorg.about.policy.lean-data.index"),
    # Issue 6756 - vanity URL, Issue 8375
    redirect(r"^decentralization/?$", "https://mozillafoundation.org/internet-health/"),
    # issue 6971
    ...
    # Issue 8375
    redirect(r"^internet-health(/.*)?", "https://mozillafoundation.org/internet-health/"),
    # Issue 8949
    redirect(r"^donate/?$", "https://mozillafoundation.org/donate/"),
    ...
    # Issue 14351
    redirect(r"^research/?$", "https://mozillafoundation.org/research/"),
    redirect(r"^research/cc/?$", "https://mozillafoundation.org/research/library/?topics=187"),
