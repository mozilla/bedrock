...
urlpatterns = (
    ...
    url('^contribute/tasks/$', views.ContributeTasks.as_view(),
        name='mozorg.contribute.tasks'),
    url('^contribute/tasks-survey/$', views.ContributeTasksSurvey.as_view(),
        name='mozorg.contribute.taskssurvey'),
    url('^contribute/tasks-thankyou/$', views.ContributeTasksThankyou.as_view(),
        name='mozorg.contribute.tasksthankyou'),
