...
urlpatterns = (
    ...
    path("firefox/all/<slug:product_slug>/", views.firefox_all, name="firefox.all_product"),
    path("firefox/all/<slug:product_slug>/<str:platform>/", views.firefox_all, name="firefox.all_platform"),
    path("firefox/all/<slug:product_slug>/<str:platform>/<str:locale>/", views.firefox_all, name="firefox.all_locale"),
