...
urlpatterns = (
    ...
    path("firefox/drill/", views.firefox_drilldown, name="firefox.drilldown"),
    path("firefox/drill/<slug:product_slug>/", views.firefox_drilldown, name="firefox.drilldown_product"),
    path("firefox/drill/<slug:product_slug>/<str:platform>/", views.firefox_drilldown, name="firefox.drilldown_platform"),
    path("firefox/drill/<slug:product_slug>/<str:platform>/<str:locale>/", views.firefox_drilldown, name="firefox.drilldown_locale"),
