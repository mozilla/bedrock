...
urlpatterns = patterns('',
    ...
    page('firefox/mobile/android-download', 'firefox/mobile/android-download.html'),
    page('firefox/mobile/android-download-beta', 'firefox/mobile/android-download-beta.html'),
