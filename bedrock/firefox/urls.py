...
urlpatterns = (
    ...
    url(r'^firefox/developer/$',
        views.FirefoxProductDeveloperView,
        name='firefox.developer'),
    url('^firefox/features/$',
        views.features, name='firefox.features.index'),
    ...
    url('^firefox/features/send-tabs/$',
        views.send_tabs, name='firefox.features.send-tabs'),
