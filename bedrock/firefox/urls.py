...
urlpatterns = (
    ...
    page('firefox/browsers', 'firefox/browsers/index.html', ftl_files=['firefox/browsers', 'banners/firefox-daylight-launch']),
    page('firefox/products', 'firefox/products/index.html', ftl_files=['firefox/products', 'banners/firefox-daylight-launch']),
    ...
    page('firefox/mobile', 'firefox/mobile/index.html', ftl_files=['firefox/mobile', 'banners/firefox-daylight-launch']),
