...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "/en-US/firefox/features/complete-pdf/",
            f"{settings.FXC_BASE_URL}/en-US/features/complete-pdf/{EXPECTED_REDIRECT_QS}",
            301,
            False,
        ),
        (
        ...
        (
            "/en-US/firefox/features/free-pdf-editor/",
            f"{settings.FXC_BASE_URL}/en-US/features/free-pdf-editor/{EXPECTED_REDIRECT_QS}",
            301,
            False,
        ),
        (
