...
class PatchFirefoxDesktopMixin:
    ...
    def setUp(self):
        ...
        self.p3 = patch.object(
            self.firefox_desktop, 'firefox_versions', self.firefox_desktop_versions
        )
        self.p1.start()
        self.p2.start()
        self.p3.start()
...
class TestFirefoxDesktop(TestCase):
    ...
    def test_get_download_url(self):
        ...
        url = self.firefox_desktop.get_download_url(
            'release', '38.0', 'win64-msi', 'en-US', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
        ...
        # Linux 64-bit
        url = self.firefox_desktop.get_download_url(
            'release', '17.0.1', 'linux64', 'en-US', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
    ...
    def test_get_download_url_esr_next(self):
        ...
        """
        url = self.firefox_desktop.get_download_url(
            'esr_next', '52.4.1esr', 'win', 'en-US', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'esr_next', '52.4.1esr', 'win64', 'en-US', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'esr_next', '52.4.1esr', 'win64-msi', 'en-US', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'esr_next', '52.4.1esr', 'osx', 'en-US', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'esr_next', '52.4.1esr', 'linux', 'en-US', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'esr_next', '52.4.1esr', 'linux64', 'en-US', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
    ...
    def test_get_download_url_devedition(self):
        ...
        # MSI installer
        url = self.firefox_desktop.get_download_url(
            'alpha', '28.0a2', 'win64-msi', 'en-US', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'alpha', '28.0a2', 'linux64', 'en-US', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
    ...
    def test_get_download_url_devedition_full(self):
        ...
        """
        url = self.firefox_desktop.get_download_url(
            'alpha', '28.0a2', 'win', 'en-US', True, True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'alpha', '28.0a2', 'win64', 'en-US', True, True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'alpha', '28.0a2', 'osx', 'en-US', True, True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'alpha', '28.0a2', 'linux', 'en-US', True, True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'alpha', '28.0a2', 'linux64', 'en-US', True, True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
    ...
    def test_get_download_url_devedition_l10n(self):
        ...
        # MSI installer
        url = self.firefox_desktop.get_download_url(
            'alpha', '28.0a2', 'win-msi', 'pt-BR', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'alpha', '28.0a2', 'linux64', 'pt-BR', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
    ...
    def test_get_download_url_nightly(self):
        ...
        # MSI installer
        url = self.firefox_desktop.get_download_url(
            'nightly', '50.0a1', 'win64-msi', 'en-US', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'nightly', '50.0a1', 'win64', 'en-US', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
        ...
        url = self.firefox_desktop.get_download_url(
            'nightly', '50.0a1', 'linux', 'en-US', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'nightly', '50.0a1', 'linux64', 'en-US', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
    ...
    def test_get_download_url_nightly_full(self):
        ...
        """
        url = self.firefox_desktop.get_download_url(
            'nightly', '50.0a1', 'win', 'en-US', True, True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'nightly', '50.0a1', 'win64', 'en-US', True, True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'nightly', '50.0a1', 'osx', 'en-US', True, True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'nightly', '50.0a1', 'linux', 'en-US', True, True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'nightly', '50.0a1', 'linux64', 'en-US', True, True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
    ...
    def test_get_download_url_nightly_l10n(self):
        ...
        url = self.firefox_desktop.get_download_url(
            'nightly', '50.0a1', 'win64', 'pt-BR', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
        ...
        # MSI installer
        url = self.firefox_desktop.get_download_url(
            'nightly', '50.0a1', 'win64-msi', 'pt-BR', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'nightly', '50.0a1', 'linux', 'pt-BR', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
        ...
        url = self.firefox_desktop.get_download_url(
            'nightly', '50.0a1', 'linux64', 'pt-BR', True
        )
        self.assertListEqual(
            parse_qsl(urlparse(url).query),
            [
    ...
    def test_get_download_url_scene2_funnelcake(self):
        ...
        url = self.firefox_desktop.get_download_url(
            'release', '45.0', 'win', 'en-US', funnelcake_id='64'
        )
    ...
    def test_get_download_url_scene2_with_locale(self):
        scene2 = self.firefox_desktop.download_base_url_transition
        url = self.firefox_desktop.get_download_url(
            'release', '45.0', 'win', 'de', locale_in_transition=True
        )
    ...
    def test_filter_builds_by_locale_name(self):
        ...
        # search native
        builds = self.firefox_desktop.get_filtered_full_builds('release', None, u'જરા')
        assert len(builds) == 1
        assert builds[0]['name_en'] == 'Gujarati'
    ...
    def test_esr_versions_no_latest(self):
        ...
        with patch.object(
            ...
            Mock(
                return_value=dict(
                    LATEST_FIREFOX_VERSION='Phoenix', FIREFOX_ESR='Albuquerque'
                )
            ),
        ):
    ...
    @patch.dict(
        os.environ, FUNNELCAKE_64_LOCALES='en-US', FUNNELCAKE_64_PLATFORMS='win'
    )
    def test_funnelcake_direct_links_en_us_win_only(self):
        ...
        """
        url = self.firefox_desktop.get_download_url(
            'release', '45.0', 'win', 'en-US', force_direct=True, funnelcake_id='64'
        )
        assert 'product=firefox-stub-f64' in url

        url = self.firefox_desktop.get_download_url(
            'release', '45.0', 'win64', 'en-US', force_direct=True, funnelcake_id='64'
        )
        assert 'product=firefox-stub-f64' not in url

        url = self.firefox_desktop.get_download_url(
            'release', '45.0', 'win', 'de', force_direct=True, funnelcake_id='64'
        )
        assert 'product=firefox-stub-f64' not in url

        url = self.firefox_desktop.get_download_url(
            'release', '45.0', 'osx', 'en-US', force_direct=True, funnelcake_id='64'
        )
        assert 'product=firefox-stub-f64' not in url
    ...
    def test_no_funnelcake_direct_links_if_not_configured(self):
        ...
        url = self.firefox_desktop.get_download_url(
            'release', '45.0', 'osx', 'de', force_direct=True, funnelcake_id='64'
        )
        assert '-f64' not in url
        ...
        url = self.firefox_desktop.get_download_url(
            'release', '45.0', 'osx', 'fr', force_direct=True, funnelcake_id='64'
        )
        assert '-f64' not in url

        url = self.firefox_desktop.get_download_url(
            'release', '45.0', 'linux', 'de', force_direct=True, funnelcake_id='64'
        )
        assert '-f64' not in url

        url = self.firefox_desktop.get_download_url(
            'release', '45.0', 'linux', 'en-US', force_direct=True, funnelcake_id='64'
        )
        assert '-f64' not in url

        url = self.firefox_desktop.get_download_url(
            'release', '45.0', 'linux', 'fr', force_direct=True, funnelcake_id='64'
        )
        assert '-f64' not in url
...
class TestFirefoxAndroid(TestCase):
    ...
    def test_get_download_url_beta(self):
        ...
        if the force_direct option is unspecified.
        """
        assert self.firefox_android.get_download_url('beta', 'arm').startswith(
            self.google_play_url_base + 'firefox_beta'
        )
        assert self.firefox_android.get_download_url('beta', 'x86').startswith(
            self.google_play_url_base + 'firefox_beta'
        )
    ...
    def test_get_download_url_release(self):
        ...
        if the force_direct option is unspecified.
        """
        assert self.firefox_android.get_download_url('release', 'arm').startswith(
            self.google_play_url_base + 'firefox'
        )
        assert self.firefox_android.get_download_url('release', 'x86').startswith(
            self.google_play_url_base + 'firefox'
        )
