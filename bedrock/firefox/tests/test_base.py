...
class TestWhatsNew(TestCase):
    ...
    # begin 134 beta whatsnew tests

    @override_settings(DEV=True)
    def test_fx_134_0_0beta_en_US(self, render_mock):
        """Should use whatsnew-fx134beta template for en-US locale"""
        req = self.rf.get("/firefox/whatsnew/")
        req.locale = "en-US"
        self.view(req, version="134.0beta")
        template = render_mock.call_args[0][1]
        assert template == ["firefox/whatsnew/whatsnew-fx134beta.html"]

    @override_settings(DEV=True)
    def test_fx_134_0_0beta_pl(self, render_mock):
        """Should use default template for pl locale"""
        req = self.rf.get("/firefox/whatsnew/")
        req.locale = "pl"
        self.view(req, version="134.0beta")
    ...
    def test_fx_133_0_0_newsletter_fr_fr_v2(self, render_mock):
        """Should use whatsnew-fx133-donation-eu-na.html template for fr locale in FR and v=2"""
        req = self.rf.get("/firefox/whatsnew/?v=2", HTTP_CF_IPCOUNTRY="FR")
        req.locale = "fr"
        self.view(req, version="133.0")
        template = render_mock.call_args[0][1]
        assert template == ["firefox/whatsnew/whatsnew-fx133-donation-eu-na.html"]

    @override_settings(DEV=True)
    def test_fx_133_0_0_newsletter_fr_fr_v3(self, render_mock):
        """Should use whatsnew-fx133-donation-eu-na.html template for fr locale in FR and v=3"""
    ...
    def test_fx_133_0_0_newsletter_de_de_v2(self, render_mock):
        """Should use whatsnew-fx133-donation-eu-na.html template for de locale in DE and v=2"""
    ...
    def test_fx_133_0_0_newsletter_de_de_v3(self, render_mock):
        """Should use whatsnew-fx133-donation-eu-na.html template for de locale in DE and v=3"""
    ...
    def test_fx_133_0_0_newsletter_en_gb_gb_v2(self, render_mock):
        """Should use whatsnew-fx133-donation-eu-na.html template for en_GB locale in GB and v=2"""
    ...
    def test_fx_133_0_0_newsletter_en_gb_gb_v3(self, render_mock):
        """Should use whatsnew-fx133-donation-eu-na.html template for en_GB locale in GB and v=3"""
    ...
    def test_fx_133_0_0_newsletter_en_us_us_v2(self, render_mock):
        """Should use whatsnew-fx133-donation-eu-na.html template for en_US locale in US and v=2"""
    ...
    def test_fx_133_0_0_newsletter_en_us_us_v3(self, render_mock):
        """Should use whatsnew-fx133-donation-eu-na.html template for en_US locale in US and v=3"""
    ...
    def test_fx_133_0_0_newsletter_en_ca_ca_v1(self, render_mock):
        """Should use whatsnew-fx133-na-fakespot.html template for en_CA locale in CA and v=1"""
    ...
    def test_fx_133_0_0_newsletter_en_ca_ca_v2(self, render_mock):
        """Should use whatsnew-fx133-donation-eu-na.html template for en_CA locale in CA and v=2"""
    ...
    def test_fx_133_0_0_newsletter_en_ca_ca_v3(self, render_mock):
        """Should use whatsnew-fx133-donation-eu-na.html template for en_CA locale in CA and v=3"""
