...
class TestWhatsNew(TestCase):
    ...
    def test_fx_143_0_0_en_CA(self, render_mock):
        """Should use index template for en-CA locale"""
        req = self.rf.get("/firefox/whatsnew/")
        req.locale = "en-CA"
    ...
    def test_fx_143_0_0_en_GB(self, render_mock):
        """Should use index template for en-GB locale"""
        req = self.rf.get("/firefox/whatsnew/")
        req.locale = "en-GB"
        self.view(req, version="143.0")
        template = render_mock.call_args[0][1]
    ...
    def test_fx_143_0_0_de(self, render_mock):
        """Should use index template for de locale"""
        req = self.rf.get("/firefox/whatsnew/")
        req.locale = "de"
        self.view(req, version="143.0")
        template = render_mock.call_args[0][1]
    ...
    def test_fx_143_0_0_fr(self, render_mock):
        """Should use index template for fr locale"""
        req = self.rf.get("/firefox/whatsnew/")
        req.locale = "fr"
        self.view(req, version="143.0")
        template = render_mock.call_args[0][1]
    ...
    def test_fx_143_0_0_en_US(self, render_mock):
        """Should use index template for en-US locale"""
        req = self.rf.get("/firefox/whatsnew/")
        req.locale = "en-US"
        self.view(req, version="143.0")
        template = render_mock.call_args[0][1]
