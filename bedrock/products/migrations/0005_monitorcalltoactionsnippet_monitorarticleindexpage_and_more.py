    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("split_heading", models.CharField(max_length=255)),
                ("split_subheading", models.CharField(blank=True, max_length=255)),
                ("split_content", wagtail.fields.RichTextField(blank=True, null=True)),
                ("split_button_text", models.CharField(max_length=255, verbose_name="Link Text")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("split_button_text", models.CharField(max_length=255, verbose_name="Link Text")),
                ("split_button_link", models.URLField(verbose_name="Link URL")),
                ("articles_heading", models.CharField(max_length=255)),
