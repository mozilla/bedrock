...
urlpatterns = (
    ...
    path("vpn/desktop/", views.VPNDesktopView.as_view(), name="products.vpn.desktop"),
    path("vpn/desktop/linux/", views.VPNLinuxView.as_view(), name="products.vpn.desktop.linux"),
    path("vpn/desktop/mac/", views.VPNMacView.as_view(), name="products.vpn.desktop.mac"),
    path("vpn/desktop/windows/", views.VPNWindowsView.as_view(), name="products.vpn.desktop.windows"),
    ...
    path("vpn/mobile/", views.VPNMobileView.as_view(), name="products.vpn.mobile"),
    path("vpn/mobile/ios/", views.VPNIosView.as_view(), name="products.vpn.mobile.ios"),
    path("vpn/mobile/android/", views.VPNAndroidView.as_view(), name="products.vpn.mobile.android"),
    page("vpn/ipad", "products/vpn/platforms/ipad", ftl_files=["products/vpn/platforms/ipad", "products/vpn/shared"]),
    # VPN Resource Center
    path(
        "vpn/resource-center/",
