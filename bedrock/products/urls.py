...
urlpatterns = (
    ...
    page('vpn/desktop/linux', 'products/vpn/platforms/linux.html',
         ftl_files=['products/vpn/platforms/linux', 'products/vpn/shared']),
    page('vpn/desktop/mac', 'products/vpn/platforms/mac.html',
         ftl_files=['products/vpn/platforms/mac', 'products/vpn/shared']),
    page('vpn/desktop/windows', 'products/vpn/platforms/windows.html',
         ftl_files=['products/vpn/platforms/windows', 'products/vpn/shared']),
    page('vpn/mobile', 'products/vpn/platforms/mobile.html',
         ftl_files=['products/vpn/platforms/mobile', 'products/vpn/shared']),
