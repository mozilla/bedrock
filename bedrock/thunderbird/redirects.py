...
redirectpatterns = (
    ...
    # bug 1123399, 1150649
    redirect(r'^thunderbird/all\.html?$', 'thunderbird.all'),
    redirect(r'^thunderbird/all-beta\.html?$', 'thunderbird.all',
             to_kwargs={'channel': 'beta'}),
    redirect(r'^thunderbird/early_releases/downloads/?$', 'thunderbird.all',
             to_kwargs={'channel': 'beta'}),
