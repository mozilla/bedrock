...
privacy-faq-mozilla-doesnt-sell-data-about-v3 = We never sell your personal data. Unlike other big tech companies that collect and profit off your personal information, we're built with privacy as the default. We don't know your age, gender, precise location, or other information Big Tech collects and profits from.
