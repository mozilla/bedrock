...
browsers-chromebook-get-firefox-browser = Get { -brand-name-firefox-browser } for { -brand-name-chromebook }

browsers-chromebook-so-youve-got = So you’ve got a { -brand-name-chromebook } — now it’s time to get the independent, automatically private { -brand-name-firefox-browser } to protect your personal data.

browsers-chromebook-browsers-chromebook-get-firefox-for = Get { -brand-name-firefox } for { -brand-name-android }

browsers-chromebook-get-firefox-desktop = Get { -brand-name-firefox } Desktop for { -brand-name-chromebook }

browsers-chromebook-x86-based-chromebook = *x86 based { -brand-name-chromebook } running { -brand-name-chromeos } 80 or later

browsers-chromebook-dropdown-copy = Get { -brand-name-firefox } for { -brand-name-chromebook }

# The span here is to display an underline underneath "Firefox"
browsers-chromebook-why-get-firefox = Why get <span>{ -brand-name-firefox }</span> for { -brand-name-chromebook }?

browsers-chromebook-while-a-chromebook = While a { -brand-name-chromebook } already has { -brand-name-chrome } installed, downloading and using { -brand-name-firefox } as your go-to browser provides you with a few benefits:
