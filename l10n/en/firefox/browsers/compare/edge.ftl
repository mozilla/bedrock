...
compare-edge-firefox-and-edge-both-offer = { -brand-name-firefox } and { -brand-name-edge } both offer excellent reading modes. With { -brand-name-firefox }, you just tap on the small icon in the search bar and the browser strips down all unnecessary elements and presents you a clean looking article. In { -brand-name-edge }, you can click on the small book icon to get a clean, easy-to-read page.
...
compare-edge-the-bottom-line-is-that-while = The bottom line is that while we suggest using { -brand-name-firefox }, the best browser for you ultimately will be the one that fits your individual needs with extension support, browser customization, speed, privacy and security.
