...
# Main title.
compare-safari-comparing-firefox-browser = Comparing { -brand-name-firefox-browser } with { -brand-name-apple } { -brand-name-safari }
...
compare-safari-like-safari-firefox-encourages = Like { -brand-name-safari }, { -brand-name-firefox } encourages its enthusiastic developer community to create <a { $attrs }>add-ons and extensions</a> to the browser. And since our platform is open-source, there’s a vast selection adding a wealth of functionality.
...
# "Screenshots" is a brand name when capitalized and plural, but also appears here as a regular, non-brand term (lowercase and singular).
compare-safari-screenshots-is-another-popular = <a { $attrs }>Screenshots</a> is another popular feature built right into the { -brand-name-firefox } browser, allowing you to easily capture a picture of your screen. When you take a screenshot, you can choose to copy the file or choose which folder you want to find it in, instead of cluttering your desktop.
