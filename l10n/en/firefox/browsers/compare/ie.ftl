...
compare-ie-there-was-a-time-not-so-long = There was a time not so long ago where { -brand-name-ie } was the most popular and widely used browser in the world. Times have changed and so has technology, but unfortunately { -brand-name-ie } has pretty much stayed the same. { -brand-name-microsoft } itself openly implores users to stop using { -brand-name-ie } and instead switch to their newer Chromium-based { -brand-name-edge } browser.
