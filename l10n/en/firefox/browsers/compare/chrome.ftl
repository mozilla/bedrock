...
compare-chrome-google-chrome-is-by-all-accounts = { -brand-name-google } { -brand-name-chrome } is by all accounts a secure browser, with features like { -brand-name-google } Safe Browsing, which helps protect users by displaying an impossible-to-miss warning when they attempt to navigate to dangerous sites or download dangerous files.
...
compare-chrome-fast-forward-to-today-the-updated = Fast-forward to today, the competitive landscape for browsers has changed, with many people beginning to question just what is happening to their online data such as browsing history, passwords, and other sensitive information. A lot has changed since 2008 when { -brand-name-chrome } came onto the scene. At { -brand-name-firefox }, we’ve been heads down, working to redesign our interface and provide users with an ever growing number of privacy and performance enhancements that are automatic by default as well as plenty of handy browser tools.
...
compare-chrome-although-not-as-extensive = Although not as extensive as { -brand-name-chrome }’s add-on library, { -brand-name-firefox }, as open-source software with a huge number of active contributors, also features an incredible number of useful extensions.
