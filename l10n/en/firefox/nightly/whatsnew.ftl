...
nightly-whatsnew-youve-just-been = You’ve just been upgraded to { -brand-name-firefox-nightly } { $version }!
...
nightly-whatsnew-if-you-want-to-v4 = If you want to know what’s happening around { -brand-name-nightly } and its community, reading our <a { $blog }>blog</a> and following us on <a { $mastodon }>Mastodon</a> are good starting points!

# Obsolete: remove after 2025-05-12
# Variables:
#   $blog (url) - link to https://blog.nightly.mozilla.org/
#   $mastodon (url) - link to https://mastodon.social/@FirefoxNightly
...
nightly-whatsnew-do-you-experience = Do you experience crashes? Unexpected behavior? Web compatibility regressions? We’d love to get them filed in <a href="{ $bugzilla }">{ -brand-name-bugzilla }</a> to make sure they don’t make it to the final release (extra karma if you add the <em>{ -brand-name-nightly }-community</em> keyword to your bug reports)!

nightly-whatsnew-go-community = Go community!
