...
privacy-book-messenger-signal-title = { -brand-name-messenger }:
...
privacy-book-sharing-is-caring = Sharing is caring – but there need to be limits!
...
privacy-book-dont-have-time = <strong>Don’t have time?</strong> Set up a { -brand-name-google } Alert for your name and get notified immediately if something new pops up online.
...
privacy-book-there-are-a = There are a bunch of tools that can help improve your level of privacy and security. And that’s great! However, you’ll still require passwords to protect your accounts.. Or would you expect the newest high-end home security system to protect you from burglars if you had no apartment door? Here’s what to do:
...
privacy-book-avoid-naming-your = <strong>Avoid naming your phone, tablet or computer after yourselves.</strong> It might seem convenient and easy to remember but it also helps others to recognize them as yours.
...
privacy-book-ask-yourselves-do = <strong>Ask yourselves:</strong> Do the different outlets report on the issues you care about? And is the information shared more or less consistent or does it differ a lot? That’s the best way to battle filter bubbles and, ultimately, also filter bubbles and, ultimately, also misinformation.
...
privacy-book-another-reason-to = <strong>Avoid background localization:</strong> Another reason to do so is that some apps don’t only save your location when you use them – many of them also run the location service in the background and may create complete motion profiles of you over time. The app vendor may then use this information for a lot of purposes, even sell it, which may not suit you.
...
privacy-book-also-reconsider-the = <strong>Limit the access.</strong> Also, reconsider the permissions you once gave to the remaining apps, including social networks, and ask yourselves: Does this app really need access to my location? My contacts? My photos? My camera and microphone?
