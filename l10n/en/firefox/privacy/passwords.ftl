...
privacy-passwords-cta- = CTA
privacy-passwords-[download-firefox] = [Download { -brand-name-firefox }]
privacy-passwords-body = BODY:
...
privacy-passwords-its-easy-to = It’s easy to prevent attackers from stealing your password when you log into an unencrypted website: Never type your password unless you see a lock icon in the URL bar, like this:
...
privacy-passwords-on-the-other = On the other hand, when you’re talking to a site that has provided proof of its legal identity, the browser will show you that identity. So for example, when you go to download { -brand-name-firefox }, you can know that you’re getting it from { -brand-name-mozilla }.
...
privacy-passwords-in-todays-internet = In today’s internet, where thousands of passwords are stolen every day and accounts are traded on the black market, it’s worth the effort to keep your online life safe. When you use { -brand-name-firefox } products, some of the effort is taken off your plate, because all our products are built to uphold our <a {{ $url_privacy_products }}>privacy promise</a>. And { -brand-name-firefox } is always guided by <a {{ $url_about_manifesto }}>Mozilla’s mission</a>, the non-profit we are backed by, to build a better internet.
