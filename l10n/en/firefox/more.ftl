...
while-on-chromebook = While a { -brand-name-chromebook } already has { -brand-name-chrome } installed, downloading and using { -brand-name-firefox } as your go-to browser provides you with a few benefits
firefox-quantum = { -brand-name-firefox-quantum }
quantum-was-revolution ={ -brand-name-firefox-quantum } was a revolution in { -brand-name-firefox } development. In 2017, we created a new, lightning fast browser that constantly improves. { -brand-name-firefox-quantum } is the { -brand-name-firefox-browser }.
...
access-your-sync = Access and sync your bookmarks, passwords, open tabs and more — everywhere you use { -brand-name-firefox }.
