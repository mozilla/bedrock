...
misinformation-page-title = Avoid misinformation with { -brand-name-firefox }
misinformation-page-desc = Misinformation is annoying, distracting and expensive. { -brand-name-firefox } helps you avoid false information – and lets you see less of it when browsing the web.
misinformation-page-subheading = See less misinformation online and focus on what’s important to you
...
misinformation-check-out-websites = Check out websites and news outlets that you trust to see if and how they report on the same topic. Content that is intended to manipulate will often use extremes and exaggerations for which there is no evidence and will not be found in well-researched reporting.
