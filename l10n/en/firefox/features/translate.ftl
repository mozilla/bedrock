...
# HTML page title
features-translate-translate-a-webpage-with-firefox = Translate a webpage with { -brand-name-firefox }
features-translate-translate-the-web = Translate the web

# HTML page description
features-translate-firefox-translations-is-an-added = Translations is an added built-in translation feature that allows you to easily browse the web in your preferred language. Learn more about how this feature in { -brand-name-firefox } works, and how { -brand-name-mozilla } helps keep what you translate private.
...
features-translate-while-other-browsers-rely-on = While other browsers rely on cloud services, the { -brand-name-firefox } translation language models are downloaded on the user’s browser and translations are done locally, so { -brand-name-mozilla } doesn’t record what webpages you translate.
...
features-translate-the-languages-below-are-what = The languages below are currently supported by { -brand-name-firefox }’s Translation feature:
...
features-translate-the-firefox-translation-feature = The { -brand-name-firefox } Translation feature is another way { -brand-name-mozilla } keeps your internet personalized and more private. { -brand-name-mozilla } doesn’t track what webpages you translate. With millions of users worldwide, { -brand-name-mozilla } wants to ensure that those who use { -brand-name-firefox } are learning, communicating, sharing, and staying informed on their own terms. <a href="{ $download }">Get started in your preferred language by downloading { -brand-name-firefox }.</a>
