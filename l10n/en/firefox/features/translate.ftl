...
# page title
features-translate-translate-the-web-title = Translate the web - directly in your Browser
# page description
# replace `English` with your language
features-translate-translate-more-than = Translate more than 100 languages to English directly in your { -brand-name-firefox-browser } - easier than ever.
...
# $attrs (string) - link to https://www.mozilla.org/en-US/firefox/all/
# replace `English` with your language
