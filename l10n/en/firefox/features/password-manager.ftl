...
# URL = https://support.mozilla.org/kb/use-master-password-protect-stored-logins
...
# Addon url = https://addons.mozilla.org/firefox/collections/4757633/password-managers/
# Black belt is connected to the mention of password master above, to convey you are competent in your own security skills.
password-manager-earn-your-second = Earn your second security black belt with { -brand-name-firefox }’s vast array of password manager <a href="{ $addons }">add-ons</a>. Choose an existing favorite or find a next-level one through expert community ratings and reviews.
