...
# Updated string
features-index-your-favorite-extensions = Your favorite extensions
...
# internetting is a catchy way of saying "using the internet", making internet into a verb.
features-index-a-better-internetting = A better internetting experience
...
features-index-sync-between-devices = { -brand-name-sync } between devices
...
# Updated string
features-index-password-manager-updated = Password manager
...
# Updated string
features-index-balanced-memory = Balanced memory
...
features-index-learn-more = Learn more
