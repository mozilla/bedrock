...
pdf-editor-open-pdf-click-image-icon = Open the PDF in { -brand-name-firefox }. Click the image icon, which will then prompt you to upload an image. Adjust size and placement of your image as needed. Click the +Alt text button on the image to add a photo description to make your PDF accessible.
