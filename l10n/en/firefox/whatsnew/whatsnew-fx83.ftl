...
# Main title
whatsnew83-main-title = Meet { -brand-name-pocket }: One place for everything
...
whatsnew83-great-stories = Great stories are waiting for you. Check out and save the articles that { -brand-name-pocket } recommends every time you open a new tab in { -brand-name-firefox }. New stories are added every hour.

whatsnew83-everything-youre-into = Everything you're into everywhere you go
whatsnew83-add-the-pocket-app = Add the { -brand-name-pocket } app to your phone or tablet so you can enjoy anything you've saved wherever you are — the kitchen, your living room or even a foyer if you've got one.
