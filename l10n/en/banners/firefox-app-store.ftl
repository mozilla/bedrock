...
banner-firefox-app-store-title = { -brand-name-firefox }: Private, Safe Browser
banner-firefox-focus-app-store-title = { -brand-name-firefox-focus }: The privacy browser
