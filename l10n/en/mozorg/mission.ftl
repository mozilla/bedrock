...
mission-at-mozilla-were-a-global-community = At { -brand-name-mozilla }, we’re a global community of technologists, thinkers and builders working together to keep the Internet alive and accessible, so people worldwide can be informed contributors and creators of the Web.
...
mission-read-the-mozilla-manifesto-to-learn = Read the <a href="{ $url }">{ -brand-name-mozilla } Manifesto</a> to learn even more about the values and principles that guide the pursuit of our mission.
...
mission-our-structure-organization-and-the = Our structure, organization, and the broader { -brand-name-mozilla } community
