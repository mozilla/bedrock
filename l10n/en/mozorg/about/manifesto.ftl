...
manifesto-details-articulate-a-vision = articulate a vision for the internet that { -brand-name-mozilla } participants want { -brand-name-mozilla-foundation } to pursue;
...
manifesto-details-the-mozilla-foundation-pleges = { -brand-name-mozilla-foundation } pledges to support the { -brand-name-mozilla } Manifesto in its activities. Specifically, we will:
...
manifesto-details-the-mozilla-foundation-invites = { -brand-name-mozilla-foundation } invites all others who support the principles of the { -brand-name-mozilla } Manifesto to join with us, and to find new ways to make this vision of the internet a reality.
