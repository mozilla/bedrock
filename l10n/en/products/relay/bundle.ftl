...
bundle-feature-more-than-servers = { $num_vpn_servers ->
  *[other] More than { $num_vpn_servers } servers
}
# Variables:
#   $num_vpn_countries (string) - the number of VPN available countries. Examples: 30, 40, 50
bundle-feature-more-than-countries = { $num_vpn_countries ->
  *[other] More than { $num_vpn_countries } countries
}
