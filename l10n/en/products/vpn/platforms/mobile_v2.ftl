...
vpn-mobile-get-a-vpn = Get a VPN for Mobile from { -brand-name-mozilla }
vpn-mobile-looking-for-a = Looking for a VPN to protect your mobile device? { -brand-name-mozilla-vpn }is backed by a non-for-profit company. Learn about how a VPN protects you and why you should trust { -brand-name-mozilla } with your privacy and security.
vpn-mobile-vpn-for-mobile = VPN for Mobile from { -brand-name-mozilla }
...
vpn-mobile-hackers-can-steal = Hackers can steal your personal data when you are using public wifi, such as in cafes or airports
