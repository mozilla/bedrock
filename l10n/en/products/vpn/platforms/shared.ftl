...
vpn-shared-feature-item-protection = Protection for up to { -vpn-available-devices } devices
vpn-shared-feature-item-access = Access to servers in { -vpn-available-countries }+ countries
...
vpn-features-devices = Connect up to { $devices } devices

# Variables:
#   $countries (number) - number of currently available countries
vpn-available-coming-soon = Available in { $countries } countries now. More regions coming soon.
