...
class TestDotlang(TestCase):
    ...
    def test_parse(self):
        ...
        parsed = parse(path)
        expected = {
            "Hooray! Your Firefox is up to date.": "F\xe9licitations&nbsp;! Votre Firefox a \xe9t\xe9 mis \xe0 jour.",
            "Your Firefox is out of date.": "Votre Firefox ne semble pas \xe0 jour.",
    ...
    def test_parse_utf8_error(self):
        ...
        expected = {"Update now": "Niha rojane bike", "Supported Devices": "C�haz�n pi�tgiriy�"}
        assert parsed == expected
        mail.outbox = []
    ...
    def test_parse_ingnores_untranslated(self):
        ...
        parsed = parse(path)
        expected = {"The State of Mozilla": "Awesome Baby! YEEEAAHHHH!!"}
    ...
    def test_extract_message_tweaks_do_not_break(self):
        ...
        """
        clean_string = "Stuff about many things."
        dirty_string = "Stuff\xa0about\r\nmany\t   things."
        trans_string = "This is the translation."
    ...
    def test_lazy_gettext_searches_specified_lang_files(self, trans_patch):
        ...
        dirty_string = "I'm The Dude, so that's what you call me, man."
