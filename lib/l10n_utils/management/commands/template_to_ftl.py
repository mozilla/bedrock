...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("-f", "--force", action="store_true", dest="force", default=False, help="Overwrite the FTL template if it exists."),
    ...
    def template_replace(self, match):
        ...
        if "%s" in str_id:
            self.stderr.write("WARNING: Place-holder with no variable name found in string. " 'Convert "%s" to a Fluent variable in the new file.')
