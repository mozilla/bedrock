...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("-f", "--force", action="store_true", dest="force", default=False, help="Overwrite the FTL file if it exists."),
    ...
    def get_ftl_strings(self):
        ...
        for str_id, string in translations.items():
            ...
            if "%s" in string:
                self.stderr.write("WARNING: Place-holder with no variable name found in string. " 'Look for "$VARIABLE_MISSING" in the new file.')
